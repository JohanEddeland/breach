...
if ischar(phi)
    ...
    switch nargin
        case 6
            [val, tau] = STL_EvalThom_IO(Sys, phi_tmp__, P, trajs, inout, relabs);
        case 7
            [val, tau] = STL_EvalThom_IO(Sys, phi_tmp__, P, trajs, inout, relabs, taus);
    end
...
switch nargin
    case 6
        [val, tau] = STL_EvalThom_IO(Sys, phi, P, trajs, inout, relabs);
    case 7
        [val, tau] = STL_EvalThom_IO(Sys, phi, P, trajs, inout, relabs, taus);
end
