function [val, tau] = STL_Eval_TESTRON(Sys, phi, P, trajs, objToUse, varargin)
%STL_EVAL_TESTRON computes the satisfaction function of a property for one or
% many traces.
% It is a variant of STL_EVAL with the difference that the input "objToUse"
% is included
% 
...
switch nargin
    case 5
        [val, tau] = STL_EvalThom_TESTRON(Sys, phi, P, trajs, objToUse);
    case 6
        if ~ischar(varargin{1})
            [val, tau] = STL_EvalThom_TESTRON(Sys, phi, P, trajs, objToUse, varargin{1});
