 ...
 *
 * File: AbstractFuelControl_M1_breach_data.c
 *
...
const ConstB_AbstractFuelControl_M1_T AbstractFuelControl_M1_b_ConstB = {
  70.0F                                /* '<S15>/Sum' */
};

/* Constant parameters (auto storage) */
const ConstP_AbstractFuelControl_M1_T AbstractFuelControl_M1_b_ConstP = {
