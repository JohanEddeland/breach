...
#include "AbstractFuelControl_M1.h"    /* Model's header file */
#include "rtwtypes.h"
...
void rt_OneStep(void)
{
  ...
  /* Check for overrun */
  if (OverrunFlag) {
    rtmSetErrorStatus(AbstractFuelControl_M1_M, "Overrun");
    return;
  }
...
int_T main(int_T argc, const char *argv[])
{
   ...
   */
  while ((rtmGetErrorStatus(AbstractFuelControl_M1_M) == (NULL)) &&
         !rtmGetStopRequested(AbstractFuelControl_M1_M)) {
    rt_OneStep();
  }
