...
#define brdemo_autotrans_rtModel       RT_MODEL_brdemo_autotrans_T
...
#define rtB                            brdemo_autotrans_B
#define BlockIO                        B_brdemo_autotrans_T
#define rtU                            brdemo_autotrans_U
#define ExternalInputs                 ExtU_brdemo_autotrans_T
#define rtX                            brdemo_autotrans_X
#define ContinuousStates               X_brdemo_autotrans_T
#define rtXdot                         brdemo_autotrans_XDot
#define StateDerivatives               XDot_brdemo_autotrans_T
#define tXdis                          brdemo_autotrans_XDis
#define StateDisabled                  XDis_brdemo_autotrans_T
#define rtY                            brdemo_autotrans_Y
#define ExternalOutputs                ExtY_brdemo_autotrans_T
#define rtP                            brdemo_autotrans_P
#define Parameters                     P_brdemo_autotrans_T
#define rtDWork                        brdemo_autotrans_DW
#define D_Work                         DW_brdemo_autotrans_T

/* Parameters (auto storage) */
struct P_brdemo_autotrans_T_ {
  real_T Vehicle_Iv;                   /* Mask Parameter: Vehicle_Iv
  ...
  real_T TorqueConverter_Kfactor[21];  /* Mask Parameter: TorqueConverter_Kfactor
                                        ...
                                        */
  real_T Vehicle_N20;                  /* Mask Parameter: Vehicle_N20
                                        * Referenced by: '<S5>/Wheel Speed'
                                        */
  real_T Vehicle_Rfd;                  /* Mask Parameter: Vehicle_Rfd
                                        * Referenced by:
                                        *   '<S5>/Final Drive Ratio1'
                                        *   '<S5>/FinalDriveRatio2'
                                        *   '<S5>/Wheel Speed'
                                        */
  real_T Vehicle_Rw;                   /* Mask Parameter: Vehicle_Rw
                                        * Referenced by: '<S5>/LinearSpeed'
                                        */
  real_T TorqueConverter_Torkratio[21];/* Mask Parameter: TorqueConverter_Torkratio
                                        * Referenced by: '<S6>/TorqueRatio'
                                        */
  real_T TorqueConverter_speedratio[21];/* Mask Parameter: TorqueConverter_speedratio
                                         * Referenced by:
                                         *   '<S6>/FactorK'
                                         *   '<S6>/TorqueRatio'
                                         */
  real_T interp_down_RowIdx[6];        /* Expression: downth
                                        * Referenced by: '<S3>/interp_down'
                                        */
  real_T interp_down_ColIdx[4];        /* Expression: [1:4]
                                        * Referenced by: '<S3>/interp_down'
                                        */
  real_T interp_down_Table[24];        /* Expression: downtab
                                        * Referenced by: '<S3>/interp_down'
                                        */
  real_T interp_up_RowIdx[6];          /* Expression: upth
                                        * Referenced by: '<S3>/interp_up'
                                        */
  real_T interp_up_ColIdx[4];          /* Expression: [1:4]
                                        * Referenced by: '<S3>/interp_up'
                                        */
  real_T interp_up_Table[24];          /* Expression: uptab
                                        * Referenced by: '<S3>/interp_up'
                                        */
  ...
  real_T Integrator_LowerSat;          /* Expression: 600
                                        * Referenced by: '<S1>/Integrator'
                                        */
  real_T EngineTorque_RowIdx[10];      /* Expression: thvec
                                        * Referenced by: '<S1>/EngineTorque'
                                        */
  real_T EngineTorque_ColIdx[11];      /* Expression: nevec
                                        * Referenced by: '<S1>/EngineTorque'
                                        */
  real_T EngineTorque_Table[110];      /* Expression: emap
                                        * Referenced by: '<S1>/EngineTorque'
                                        */
  real_T LookUpTable_XData[4];         /* Expression: [1 2 3 4]
                                        * Referenced by: '<S7>/Look-Up Table'
                                        */
  real_T LookUpTable_YData[4];         /* Expression: [2.393 1.450 1.000 0.677]
                                        * Referenced by: '<S7>/Look-Up Table'
                                        */
  real_T engineimpellerinertia_Gain;   /* Expression: 1/Iei
...
extern P_brdemo_autotrans_T brdemo_autotrans_P;
...
extern void brdemo_autotrans_output(void);
extern void brdemo_autotrans_update(void);
extern void brdemo_autotrans_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern brdemo_autotrans_rtModel *brdemo_autotrans(void);
